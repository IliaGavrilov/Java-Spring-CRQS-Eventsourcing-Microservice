...
public class BalanceDebitedEvent extends BaseEvent {
    ...
    @Builder
    public BalanceDebitedEvent(String aggregateId, BigDecimal amount, String email, BigDecimal balance, BigDecimal debit, BigDecimal credit, BigDecimal creditLine, BigDecimal overdraftLimit) {
